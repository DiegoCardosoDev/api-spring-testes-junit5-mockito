...
class UserResourceTest {
    ...
    void whenDeleteThenReturnSuccess() {
        ...
        //asseguramos
        assertNotNull(response);//nao pode ser nulo
        assertEquals(ResponseEntity.class, response.getClass());//espera um response entity
        verify(service, times(1)).delete(anyInt());//delete so pode ser chamado uma vez
